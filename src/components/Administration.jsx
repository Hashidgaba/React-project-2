...
export default function Administration() {
  return (
    <div>
      <h2 className='chairman'>  Chairman</h2>
      <div className='flex-conatiner'>
        <div className='img-cont'>
          <img className='img' src='https://www.t.edu.pk/files/images/sarfraz-muzaffar-new.jpg' />
          <div className='text'>MUHAMMAD SARFRAZ MUZAFFAR</div>
        </div>
